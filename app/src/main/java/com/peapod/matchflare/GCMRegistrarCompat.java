    ...
    static public class BaseRegisterTask extends
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                sendRegistrationIdToServer(regid,contact_id);
            }
            catch (IOException e) {
        ...
        protected void sendRegistrationIdToServer(String regid, String contact_id) {
            Log.e("Sending server the for contact " + contact_id + " with registration Id: ",regid);
